<template>
  <div id="start">
    <div class="container">
      <div class="p-8">
        <div class="w-50 bg-dark mx-auto d-block rounded py-3 px-3">
          <img src="../assets/uitdaging.png" class="img-fluid rounded" alt="">
        </div>
      </div>
    </div>
    <div class="container text-white">
      <div class="d-flex justify-content-center">
        <div class="mx-md-auto bg-dark bg-opacity-75 rounded mt-2 py-1">
          <div class="container">
            <hr>
            <div class="d-flex justify-content-center">
